...
> **Canon projet :** ce fichier est la copie de travail sous `references/recherche/`. Une copie d’archive BMAD est conservée dans `_bmad-output/archive/2026-03-31_pivot-brownfield-recyclique-1.4.4/planning-artifacts/research/technical-affichage-dynamique-peintre-extension-points-research-2026-02-25.md`.
