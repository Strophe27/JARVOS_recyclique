...
|------------|--------------|------|
| [**2026-04-19_02_point-situation-kanban-idees-jarvos**](../artefacts/2026-04-19_02_point-situation-kanban-idees-jarvos.md) | 2026-04-19 | Dernière photo : inventaire **22** cartes + delta vs 2026-04-18 ; renvoie au détail du 18 pour les tableaux par carte inchangés. |
...
**Vue tabulaire** des idées : [index.md](index.md).
