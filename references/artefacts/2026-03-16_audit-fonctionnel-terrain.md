...
- [x] Users pending : **Partiel** -- Pas d'ecran ni lien dedie "utilisateurs en attente". Dans /users, onglet "En attente" present : "Aucune inscription en attente". Normal (pas d'auto-inscription). Relique V0.1 (creation user via Telegram) abandonnee -- pas prioritaire.
