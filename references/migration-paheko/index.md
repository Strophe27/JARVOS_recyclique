...
| `2026-04-18_spec-corrections-qa-parametrage-comptable-superadmin.md` | **Grille QA / correctifs** sur l’écran Paramétrage comptable (SuperAdmin) : priorité B1–B3, manquants M*, améliorations I* ; issu du dépôt staging. _(Charger si : fin d’écarts après implémentation partielle, reprise audit sur comptes 7541/672, moyens Don/Virement, champs journal/libellés, UX clôture.)_ |
