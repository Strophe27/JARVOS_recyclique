...
- **Déléguer** l'exécution détaillée d'une story : lancer un **Task** (ou session dédiée) avec l'agent **`bmad-story-runner`** et un **brief YAML** minimal conforme à la spec §6.2 (chemins **absolus**, `story_key`, compteurs à zéro, liste des `SKILL.md` à lire).
