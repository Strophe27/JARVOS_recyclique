...
export const NAV_LABEL_PRESENTATION_FALLBACKS: Readonly<Record<string, string>> = {
  ...
  'nav.transverse.admin.pending': 'Utilisateurs en attente',
  'nav.transverse.admin.cashRegisters': 'Caisses enregistrées',
  'nav.transverse.admin.sites': 'Sites (legacy)',
  'nav.transverse.admin.sessionManager': 'Sessions caisse (supervision)',
  'nav.transverse.admin.receptionStats': 'Stats reception (supervision)',
  'nav.transverse.admin.receptionSessions': 'Sessions reception (tickets)',
