 ...
 *
 * Hiérarchie de vérité (rappel) : autorité backend / OpenAPI et **ContextEnvelope** → **NavigationManifest** →
 * **PageManifest** → **UserRuntimePrefs** (dernier maillon : présentation locale uniquement).
 *
