...
export interface PageManifest {
  ...
  /**
   * Permissions alternatives : au moins une clé doit être satisfaite si présente.
   * snake_case JSON : `required_permission_any_keys`.
   */
  readonly requiredPermissionAnyKeys?: readonly string[];
