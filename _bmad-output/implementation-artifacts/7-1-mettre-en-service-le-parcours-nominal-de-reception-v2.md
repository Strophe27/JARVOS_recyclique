...
**Sources mapping :** [Source: `references/ancien-repo/fonctionnalites-actuelles.md` §4] ; [Source: `references/migration-paeco/audits/audit-reception-poids-recyclic-1.4.4.md` §1–2] ; [Source: `references/migration-paeco/audits/matrice-correspondance-caisse-poids.md` — poids réception kg, flux matière RecyClique source].
