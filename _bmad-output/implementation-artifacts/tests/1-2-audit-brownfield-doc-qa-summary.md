...
5. **Spot-check liens §8–9** : `contracts/README.md`, `contracts/creos/schemas/README.md`, indices `references/ancien-repo/`, `references/migration-paheko/` — chemins attendus dans le dépôt (pas de dump sensible dans l'artefact).
