...
- `references/migration-paeco/audits/audit-reception-poids-recyclic-1.4.4.md` — sections 1–3 (workflow, tableau API ↔ BDD, arbitrages poids / catégories).
- `references/migration-paeco/audits/matrice-correspondance-caisse-poids.md` — cohérence **kg** réception vs autres flux.
