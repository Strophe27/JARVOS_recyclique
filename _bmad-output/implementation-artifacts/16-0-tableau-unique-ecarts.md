...
| E16-B-005 | 16.2 | B | P2 | stub | derive subie | Journalisation email non priorisee dans le perimetre livre | Logs email admin non implementes (liste vide) | Visibilite operationnelle reduite sur l'historique des envois | `api/routers/v1/admin/email_logs.py`, `frontend/src/admin/AdminEmailLogsPage.tsx`, `_bmad-output/implementation-artifacts/17-8-preuve-pytest-email-logs.txt`, `17-8-journal-verification-logs-email.md` | ferme (17.8: table email_logs, enregistrement, API filtres, front, preuves) |
| E16-B-006 | 16.2 | B | P2 | stub | derive subie | Reporting admin livre en version minimale non finalisee | Rapports caisse by-session/export-bulk restent minimaux (texte/IDs) | Valeur metier partielle pour reporting et exports | `api/routers/v1/admin/reports.py`, `frontend/src/admin/AdminReportsPage.tsx`, `_bmad-output/implementation-artifacts/17-9-preuve-pytest-reports.txt`, `17-9-exemple-sortie-export.md` | ferme (17.9: CSV enrichi by-session, ZIP export-bulk, telechargements front) |
| E16-B-007 | 16.2 | B | P2 | derive assumee | derive assumee | Decision de scope Epic 15 concentree sur 3 blocs dashboard sans exposition complete des routes techniques | Discoverabilite superadmin phase 2 incomplete (routes techniques presentes hors menu superadmin) | Accessibilite fonctionnelle degradee pour admin technique | `frontend/src/admin/AdminDashboardPage.tsx`, `frontend/src/admin/AdminDashboardPage.test.tsx`, `16-2-annexe-superadmin-phase2.md`, `_bmad-output/implementation-artifacts/17-10-preuve-vitest-admin-dashboard-superadmin.txt`, `_bmad-output/implementation-artifacts/17-10-discoverabilite-super-admin-phase-2-dans-la-navigation.md` | ferme (17.10: discoverabilite menu super-admin phase 2 restauree, 3 liens db/import-legacy/quick-analysis visibles, tests 9/9) |
...
| E16-C-007 | 16.3 | C | P2 | stub | derive subie | Tests limites au contrat de stub sans verification d'effet metier reel | Couverture admin technique surtout "happy path stub" (assertions structurelles) | Faux sentiment de robustesse sur BDD/import legacy | `api/tests/routers/test_admin_db_import_legacy.py`, `api/routers/v1/admin/db.py`, `api/routers/v1/admin/import_legacy.py`, `_bmad-output/implementation-artifacts/17-11-preuve-pytest-admin-technique.txt`, `_bmad-output/implementation-artifacts/17-11-couverture-cas-erreur.md` | ferme (17.11: tests 401/403/400/422, assertions effet metier, 41 tests verts) |
