...
| **H2** | Livrables **10.2–10.6** aux chemins `doc/*` cités en **10.7** `evidence_anchors` | Smoke : liens + existence paths agrégés |
...
| FM7 | Forcer **10.1** **`done`** | Masquer dette bandeau | Snapshot + risque explicite | **1**, **6** |
