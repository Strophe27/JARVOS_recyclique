# Brief Story Runner — Epic 2 — Story 2.7

## YAML story_run (spec §6.2)

```yaml
story_key: "2-7-fournir-les-signaux-backend-minimaux-pour-bandeau-live"
epic_id: epic-2
...
paths:
  ...
  story_file: "D:\\users\\Strophe\\Documents\\1-IA\\La Clique Qui Recycle\\JARVOS_recyclique\\_bmad-output\\implementation-artifacts\\2-7-fournir-les-signaux-backend-minimaux-pour-bandeau-live.md"
...
notes:
  - "Signaux bandeau live minimal pour Epic 4 ; etats degrades explicites ; pas de scope admin elargi."
```

## Annexe — Context pack Epic 2 / Story 2.7

Signaux exploitation (horaires, ouvertures decalees, sync, validite contexte) ; prerequis Epic 1 signaux. Payload autoritaire vs presentation. OpenAPI a jour.
