...
def upgrade() -> None:
    """Idempotent : volumes brownfield peuvent déjà contenir la table sans stamp Alembic."""
    bind = op.get_bind()
    insp = sa.inspect(bind)
