...
export const cssVariablesResolver: CSSVariablesResolver = () => ({
  variables: {
    ...
    '--ui-color-brand-header': visualTokens.colors.brandScale[8],
    '--ui-color-stats-bar-bg': visualTokens.colors.statsBarBg,
    '--ui-color-deferred-bg': visualTokens.colors.deferredBackground,
    '--ui-color-deferred-text': visualTokens.colors.deferredText,
    '--ui-color-deferred-border': visualTokens.colors.deferredBorder,
    '--ui-color-deferred-hover': visualTokens.colors.deferredHover,
