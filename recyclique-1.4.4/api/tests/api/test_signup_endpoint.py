...
class TestAuthSignupEndpoint:
    ...
    def test_signup_success_valid_data(self, client, db_session: Session):
    ...
    def test_signup_success_without_email(self, client, db_session: Session):
    ...
    def test_signup_failure_username_already_exists(self, client, db_session: Session):
    ...
    def test_signup_validation_error_short_username(self, client):
    ...
    def test_signup_validation_error_long_username(self, client):
    ...
    def test_signup_validation_error_short_password(self, client):
    ...
    def test_signup_validation_error_invalid_email(self, client):
    ...
    def test_signup_creates_user_with_correct_defaults(self, client, db_session: Session):
    ...
    def test_signup_password_hashing(self, client, db_session: Session):
    ...
    def test_signup_response_structure(self, client, db_session: Session):
    ...
    def test_signup_case_sensitive_username(self, client, db_session: Session):
