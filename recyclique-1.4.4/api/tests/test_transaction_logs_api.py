...
Vérifie que l'endpoint GET …/admin/transaction-logs (préfixe ``settings.API_V1_STR``) fonctionne correctement
...
_ADMIN_TX = f"{settings.API_V1_STR.rstrip('/')}/admin/transaction-logs"
...
class TestTransactionLogsAPI:
    ...
    def test_get_transaction_logs_pagination(self, admin_client):
        ...
        # Première page
        response1 = admin_client.get(f"{_ADMIN_TX}?page=1&page_size=2")
        ...
        # Deuxième page
        response2 = admin_client.get(f"{_ADMIN_TX}?page=2&page_size=2")
    ...
    def test_get_transaction_logs_filter_by_event_type(self, admin_client):
        ...
        response = admin_client.get(f"{_ADMIN_TX}?event_type=SESSION_OPENED")
    ...
    def test_get_transaction_logs_filter_by_user_id(self, admin_client):
        ...
        response = admin_client.get(f"{_ADMIN_TX}?user_id=user-1")
    ...
    def test_get_transaction_logs_filter_by_session_id(self, admin_client):
        ...
        response = admin_client.get(f"{_ADMIN_TX}?session_id=session-1")
