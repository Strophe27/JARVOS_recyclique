...
> Note 2026-03-26 : document conserve pour historique QA.
> Les scenarios ci-dessous supposent encore l'appel a `POST /deposits/{id}/classify`.
> Dans l'etat courant du projet, ce flux bot n'est plus un parcours actif de reference et la route correspondante est desactivee (`410 Gone`).
> Ne pas utiliser ce fichier comme specification d'execution courante sans verifier le contrat runtime actuel.
