...
1. **Task `generate_meeting_report`**
   ...
   - Lit index dans `meetings/2025-12-05-reunion-recycclique/working/index.json`
   ...
   - Génère `meetings/2025-12-05-reunion-recycclique/final/compte-rendu.md` avec structure complète
...
- Compte-rendu final dans `meetings/2025-12-05-reunion-recycclique/final/compte-rendu.md`
