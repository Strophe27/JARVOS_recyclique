...
1. **Task `inverse_validation`**
   ...
   - Lit transcription complète dans `meetings/2025-12-05-reunion-recycclique-essai2/transcriptions/full-transcript.json`
   - Compare documents ↔ transcriptions
   - Détecte incohérences, oublis, divergences
   - Génère rapport dans `meetings/2025-12-05-reunion-recycclique-essai2/working/validation-report.md`
...
- Rapport de validation dans `meetings/2025-12-05-reunion-recycclique-essai2/working/validation-report.md`
