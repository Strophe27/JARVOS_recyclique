...
1. **Task `summarize_segments`**
   - Lit l'index `meetings/2025-12-05-reunion-recycclique-essai2/working/index.json`
   ...
   - Sauvegarde dans `meetings/2025-12-05-reunion-recycclique-essai2/working/summaries/summary-{num}.md`

### 3.2. Agrégation des threads

1. **Task `build_threads`**
   - Lit tous les résumés dans `meetings/2025-12-05-reunion-recycclique-essai2/working/summaries/`
   - Identifie threads (sujets récurrents) par tags similaires
   - Crée fichier `meetings/2025-12-05-reunion-recycclique-essai2/working/threads.md` avec threads agrégés
...
- Résumés dans `meetings/2025-12-05-reunion-recycclique-essai2/working/summaries/summary-{num}.md`
- Threads agrégés dans `meetings/2025-12-05-reunion-recycclique-essai2/working/threads.md`
