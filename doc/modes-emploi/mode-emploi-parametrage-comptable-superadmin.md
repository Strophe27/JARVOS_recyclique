...
**Version :** 1.2 · **Dernière mise à jour :** 2026-04-18 (exercice Paheko : saisie manuelle Option B ; extension API liste exercices = plus tard ; alignement décisions produit spec QA).
